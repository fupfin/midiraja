...
class Ay8910MidiConverterTest {
    ...
    void noiseVelocity_reflectsChannelVolume() throws Exception {
        ...
        // toVelocity(8) = round(sqrt(8/15) * 127) = 93
        assertEquals(93, noteOn.getData2(), "Noise velocity must reflect channel volume");
    }
    ...
    void envelopeMode_triggersNoteOn_withReducedVelocity() throws Exception {
        ...
        // toVelocity(7) = round(sqrt(7/15) * 127) = 87
        assertEquals(87, cc7.getData2(), "Decay envelope (R13=0) → effective vol=7 → CC7=87");
    }
    ...
    void envelopeShape13_sustainedHigh_usesHigherVelocity() throws Exception {
        ...
        assertNotNull(cc7);
        // R13=13 → effective vol=11 → CC7=round(sqrt(11/15)*127)=109
        assertEquals(109, cc7.getData2(), "Sustained envelope (R13=13) → effective vol=11 → CC7=109");
    }
