...
class GusEngineTest
{
    ...
    {
        GusEngine engine = new GusEngine(44100);
        ...
        GusPatch.Instrument inst = new GusPatch.Instrument(0, "Test", List.of(sample));
        ...
        assertEquals(2.0, engine.getActiveVoices().get(1).getPlaybackRatio(), 0.001);
    ...
    void testAudioRendering()
    {
        ...
        GusPatch.Sample sample = new GusPatch.Sample(10, 0, 0, 44100, 20, 20000, 440000, (short) 64,
    ...
    void testSampleLooping()
    {
        ...
        GusPatch.Sample sample = new GusPatch.Sample(10, 4, 8, 44100, 20, 20000, 440000, (short) 64,
                false, false, pcmSegment);
        GusPatch patch = new GusPatch(
                "Looping Patch",
                List.of(new GusPatch.Instrument(0, "Test", List.of(sample))));
    ...
    void testReleaseEnvelope()
    {
        ...
        GusPatch.Sample sample = new GusPatch.Sample(1000, 0, 0, 44100, 20, 20000, 440000, (short) 64,
                false, false, pcmSegment);
        GusPatch patch = new GusPatch(
                "Envelope Patch",
                List.of(new GusPatch.Instrument(0, "Test", List.of(sample))));
