...
/**
 * Abstraction for an audio output engine. Decouples MIDI synthesis providers from the native
 * FFM/JNI audio drivers (DIP principle).
 */
public interface AudioEngine extends AutoCloseable
{
     ...
     * @param bufferSize
     *            Size of the internal audio buffer in frames.
     */
    ...
    int push(short[] pcm, int offset, int length);
