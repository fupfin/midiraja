...
import static com.fupfin.midiraja.format.vgm.FmMidiUtil.*;
 ...
 *
 * <p>
 * The YM2612 has 6 FM channels split across two ports. VGM commands 0x52 (port 0, chip id 1)
 ...
 *
 * <p>
 * <b>Key-on register 0x28 encoding:</b> Bits 3-0 select the channel using a non-contiguous
 ...
 *
 * <p>
 * <b>F-Number write order:</b> The YM2612 requires the high byte (0xA4-0xA6) to be written
 ...
 *
 * <p>
 * <b>Dynamic Program Change:</b> FM timbre is determined by operator parameters (TL, AR,
...
public class Ym2612MidiConverter
{
    ...
    /**
     * @param fmDivider
     *            FM frequency divider: 144 for YM2612/YM2608/YM2610, 72 for YM2203
     * @param port1ChipId
     *            chip ID that indicates port 1 events; -1 for single-port chips (YM2203)
     */
