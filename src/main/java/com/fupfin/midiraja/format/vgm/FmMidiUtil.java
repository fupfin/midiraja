 ...
 *
 * <p>
 * All OPN/OPM-family chips share the same eight algorithm topologies and four-operator
...
public final class FmMidiUtil
{
     ...
     *
     * <p>
     * Uses the first note's pitch to determine the channel's role (bass vs melody),
     ...
     *
     * @param note
     *            MIDI note number of the current note (0–127)
     * @param percussive
     *            true if carrier envelope has fast attack + fast decay
     */
     ...
     *
     * <p>
     * Operator index ordering: 0=first slot, 1=second slot, 2=third slot, 3=fourth slot.
