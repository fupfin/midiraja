 ...
 *
 * <p>
 * The VGM D2 command carries three bytes: port, address, data. Port selects the register bank:
 * <ul>
 ...
 *
 * <p>
 * Frequency formula: {@code f = clock / (32 × (N + 1))} where N is the 12-bit divider.
 *
 * <p>
 * <b>Enable register design decision:</b> The K051649 enable register is not used as a MIDI
 ...
 *
 * <p>
 * <b>SCC clock fallback (in VgmParser):</b> The K051649 clock field in the VGM header is 0
...
public class SccMidiConverter
{
    ...
    public void convert(VgmEvent event, Track[] tracks, long clock, long tick)
    {
        ...
        switch (port)
        {
            ...
            case 3 ->
            {
                // channel enable — not used for MIDI gating (see class javadoc)
            }
        }
    }
     ...
     *
     * <p>
     * The {@code (fnum + 1)} term is required by the K051649 specification: the divider counts
