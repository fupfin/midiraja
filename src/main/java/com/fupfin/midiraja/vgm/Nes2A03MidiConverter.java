 ...
 * </ul>
 *
 * <p>VGM command 0xB4 carries a register offset (0x00-0x17 mapping to $4000-$4017)
 * and a data byte.
 *
 * <p><b>Frequency encoding:</b> Pulse channels use an 11-bit timer period where
 * f = clock / (16 × (period + 1)). Triangle uses f = clock / (32 × (period + 1)),
 * producing a note one octave lower for the same period value.
 *
 * <p><b>Volume:</b> Pulse and noise use a 4-bit volume in bits 3-0 of $4000/$4004/$400C
 ...
 *
 * <p><b>Trigger:</b> Writing to $4003/$4007/$400B/$400F reloads the length counter,
...
public class Nes2A03MidiConverter {
    ...
    public void convert(VgmEvent event, Track[] tracks, long clock, long tick) {
        ...
        switch (reg) {
            ...
            default -> {} // $4001/$4005 sweep, $4009 unused, $4011 DPCM direct, etc.
        }
    }
