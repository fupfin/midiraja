 ...
 *
 * <p><b>Silent detection:</b> {@code conn=0, fb=0} is a note-cut trick used by many OPL2
 ...
 *
 * <p><b>Drum detection:</b> Strong modulation ({@code modTL < 10}) with non-zero feedback
