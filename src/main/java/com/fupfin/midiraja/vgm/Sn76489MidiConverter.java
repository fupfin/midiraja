 ...
 *
 * <p>
 * The SN76489 has 3 tone generators and 1 noise generator. <b>Volume encoding is inverted:</b>
 ...
 *
 * <p>
 * Frequency formula: {@code f = clock / (32 × N)} where N is the 10-bit tone counter.
 *
 * <p>
 * <b>Noise channel → GM percussion ch 9:</b> The SN76489 noise channel (chip channel 3)
 ...
 *
 * <p>
 * <b>Volume changes use CC7, not re-trigger:</b> When volume changes while a note is
...
public class Sn76489MidiConverter
{
    ...
    {
        if (volume[ch] == 15 || activeNote[ch] < 0)
            return;
