...
/**
 * A global audio effect that simulates the harmonic distortion and soft clipping of an analog
 * vacuum tube amplifier or magnetic tape saturation.
 *
 * It uses a mathematically optimized waveshaping curve to add warmth, thickness, and punch to
 * digital synthesizers like OPL and PSG.
 */
