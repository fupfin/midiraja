 ...
 * @param channel      format channel index (0-based)
 * @param note         MIDI note number (0–127), {@code -1} for no note, {@code -2} for key-off/cut
 ...
 * @param effectCmd    effect command byte (format-specific), or 0 for none
