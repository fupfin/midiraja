...
public interface TerminalIO
{
    ...
    enum TerminalKey
    {
        NONE, SEEK_FORWARD, SEEK_BACKWARD, VOLUME_UP, VOLUME_DOWN, SPEED_UP, SPEED_DOWN, TRANSPOSE_UP, TRANSPOSE_DOWN, NEXT_TRACK, PREV_TRACK, QUIT, PAUSE, BOOKMARK, RESUME_SESSION, TOGGLE_LOOP, TOGGLE_SHUFFLE, TOGGLE_METER_MODE
    }
