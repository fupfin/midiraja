...
| [Tracker Format Engineering](tracker-format-engineering.md) | MOD/XM/S3M/IT format architecture — why MOD is supported, why IT/XM/S3M are not, future dynamic SF2 extension path, OS MIDI port limitations |
