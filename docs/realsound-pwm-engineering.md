...
Simple truncation quantization causes severe harmonic distortion. To prevent this, a **First-order Leaky Delta-Sigma** algorithm is applied strictly to the quantization stage.
...
This converts the terrible metallic screeching inherent in low bit-depths (e.g., 6-bit, 8-bit) into a smooth, warm analog tape hiss.
...
*   **Custom Degradation:**
    ...
    ```bash
    midra gus --bits 4 --pwm <your_midi_file.mid>
    ```