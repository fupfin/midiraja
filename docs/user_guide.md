...
* **[📻 PC Speaker / RealSound Engineering](retro/retro-pc(realsound)-engineering.md)**: A deep dive into time-domain PWM quantization, carrier sideband analysis, and the 7-pole cone IIR model behind `--retro pc`.
