...
- [ ] Task: Implement Dynamic Horizontal Scaling
...
- [ ] Task: Implement Dynamic Vertical Scaling
...
- [ ] Task: Refine `uiLoop` performance
...
- [ ] Task: Add integration/unit tests for the layout engine logic.
- [ ] Task: Conductor - User Manual Verification 'PlaybackEngine TUI Layout Refactoring' (Protocol in workflow.md)
